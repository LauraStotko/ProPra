...
def find_unique_sequences(sequences, ks, start):
...
def main():
    parser = argparse.ArgumentParser(
        description='Identifiziert einzigartige Basenfolgen in Genen an einer gegebenen Position.')
    ...
    parser.add_argument('--start', type=int, default=0, help='Startposition für die Subsequenzextraktion (Standard: 0)')
